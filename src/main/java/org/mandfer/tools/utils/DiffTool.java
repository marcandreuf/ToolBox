...
public class DiffTool {
     ...
     * stripping any commons prefix or suffix off the texts before diffing.
     *
     * @param text1      Old string to be diffed.
     * @param text2      New string to be diffed.
     * @param checklines Speedup flag.  If false, then don't run a
    ...
    private LinkedList<Diff> diff_main(String text1, String text2,
        ...
        // Trim off commons prefix (speedup).
        int commonlength = diff_commonPrefix(text1, text2);
        String commonprefix = text1.substring(0, commonlength);
        text1 = text1.substring(commonlength);
        text2 = text2.substring(commonlength);

        // Trim off commons suffix (speedup).
     ...
     * have any commons prefix or suffix.
     *
     * @param text1      Old string to be diffed.
     * @param text2      New string to be diffed.
     * @param checklines Speedup flag.  If false, then don't run a
    ...
    /**
     * Determine the commons prefix of two strings
     *
     * @param text1 First string.
     * @param text2 Second string.
     * @return The number of characters commons to the start of each string.
     */
    ...
    /**
     * Determine the commons suffix of two strings
     *
     * @param text1 First string.
     * @param text2 Second string.
     * @return The number of characters commons to the end of each string.
     */
     ...
     * @param text1 First string.
     * @param text2 Second string.
     * @return The number of characters commons to the end of the first
     ...
     * commons middle.  Or null if there was no match.
     */
     ...
     * and the commons middle.  Or null if there was no match.
     */
            ...
            switch (thisDiff.operation) {
                ...
                case EQUAL:
                    if (count_delete + count_insert > 1) {
                        ...
                        if (both_types) {
                            // Factor out any commons prefixies.
                            ...
                            // Factor out any commons suffixies.
