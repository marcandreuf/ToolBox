<?php
	...
	*/
	...
	define('SECURITY_PHRASE', 'xxxx'); //TO FIX BEFORE FIRST RUN. SETUP A PHRASE !!!
	define('PASSWORD', '');
	define('ADMIN', TRUE);  //CAREFUL THIS IS SETUP AS ADMIN, PLEASE CHECK THE Readme.txt file.
